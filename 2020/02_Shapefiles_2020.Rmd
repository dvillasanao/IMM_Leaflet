...
```{r}
shape_municipios <- readOGR(dsn = "D:/MGN/MGN Diciembre 2020/MGN Diciembre 2020/conjunto_de_datos",
                             layer = "00mun",
                              encoding = "UTF-8",
                               use_iconv = TRUE)
...
capa_municipios_1 <- shape_municipios %>%
                      spdplyr:::inner_join.Spatial(., IMM_2020 %>% 
                                                       select(CVE_MUN, GM_2020) %>%
...
```{r}
saveRDS(shape_estados, paste0(here::here(), "/2020/Output/Shapes/shape_estados.rds"))
saveRDS(capa_municipios_1, paste0(here::here(), "/2020/Output/Shapes/shape_municipios_1.rds"))
saveRDS(capa_municipios_2, paste0(here::here(), "/2020/Output/Shapes/shape_municipios_2.rds"))
saveRDS(capa_municipios_3, paste0(here::here(), "/2020/Output/Shapes/shape_municipios_3.rds"))
saveRDS(capa_municipios_4, paste0(here::here(), "/2020/Output/Shapes/shape_municipios_4.rds"))
saveRDS(capa_municipios_5, paste0(here::here(), "/2020/Output/Shapes/shape_municipios_5.rds"))
```
...
geojsonio::geojson_write(capa_estados_mapshaper, file = paste0(here::here(), "/2020/Output/Shapes/estados_json.geojson"))
geojsonio::geojson_write(capa_municipios_1_mapshaper, file = paste0(here::here(), "/2020/Output/Shapes/municipios_1_json.geojson"))
geojsonio::geojson_write(capa_municipios_2_mapshaper, file = paste0(here::here(), "/2020/Output/Shapes/municipios_2_json.geojson"))
geojsonio::geojson_write(capa_municipios_3_mapshaper, file = paste0(here::here(), "/2020/Output/Shapes/municipios_3_json.geojson"))
geojsonio::geojson_write(capa_municipios_4_mapshaper, file = paste0(here::here(), "/2020/Output/Shapes/municipios_4_json.geojson"))
geojsonio::geojson_write(capa_municipios_5_mapshaper, file = paste0(here::here(), "/2020/Output/Shapes/municipios_5_json.geojson"))
```

```{r}
# Se guarda como objeto
saveRDS(capa_estados_mapshaper, paste0(here::here(), "/2020/Output/Shapes/capa_estados_mapshaper.rds"))
saveRDS(capa_municipios_1_mapshaper, paste0(here::here(), "/2020/Output/Shapes/capa_municipios_1_mapshaper.rds"))
saveRDS(capa_municipios_2_mapshaper, paste0(here::here(), "/2020/Output/Shapes/capa_municipios_2_mapshaper.rds"))
saveRDS(capa_municipios_3_mapshaper, paste0(here::here(), "/2020/Output/Shapes/capa_municipios_3_mapshaper.rds"))
saveRDS(capa_municipios_4_mapshaper, paste0(here::here(), "/2020/Output/Shapes/capa_municipios_4_mapshaper.rds"))
saveRDS(capa_municipios_5_mapshaper, paste0(here::here(), "/2020/Output/Shapes/capa_municipios_5_mapshaper.rds"))
```
